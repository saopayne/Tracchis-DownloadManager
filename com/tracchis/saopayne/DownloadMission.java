 ...
 * @author saopayne
 */
@XmlRootElement(namespace = "com.tracchis.saopayne")
...
public class DownloadMission {
	...
	private void resumeMission() throws IOException {
		try {
			File progressFile = new File(FileUtils.getSafeDir(mProgressDir)
			...
			File targetSaveFile = new File(
					FileUtils.getSafeDir(mission.mSaveDirectory
	...
	public static DownloadMission recoverMissionFromProgressFile(
		...
		try {
			File progressFile = new File(
					FileUtils.getSafeDir(progressDirectory)
